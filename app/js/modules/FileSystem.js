...
FileSystem.prototype.errorHandler = function(){
        var msg = '';
        switch (e.code) {
...
FileSystem.prototype.write = function filesStorageService_write(fileName, type, content, done) {
    var self = this;
    try {
...
FileSystem.prototype.read = function filesStorageService_read(fileName, done) {
    try {
...
FileSystem.prototype.append = function filesStorageService_append(fileName, type, content, done) {
    try {
...
FileSystem.prototype.remove = function filesStorageService_remove(fileName, done) {
    try {
...
FileSystem.prototype.removeByPath = function filesStorageService_removeByPath(path, done) {
    if (path) {
